 ...
 * @return
 */
GATTError GATT_read_characteristic_value(uint16_t service_uuid, uint16_t char_uuid,
 ...
 * @return
 */
GATTError GATT_send_indication(uint16_t connection_handle, uint16_t char_handle,
                               uint8_t *value, uint16_t length);
